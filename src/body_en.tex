...
\cvlistitem{Secure DevOps (DevSecOps)}
...
%%%
\cvlistitem{SAST (Opentext Fortify ScanCentral, Snyk)}
\cvlistitem{DAST (Opentext Fortify WebInspect)}
\cvlistitem{SCA (Sonatype IQ Server, Sinopsys BlackDuck)}
