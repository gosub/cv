\section{Profilo}
\cvline{}{Security engineer / cybersecurity architect con oltre 20 anni di esperienza tra sviluppo software, amministrazione di sistemi e security engineering. Negli ultimi anni mi sono concentrato su piattaforme di Application Security e DevSecOps in contesti enterprise, con attività hands-on su Fortify ScanCentral / SSC, IQ Server, WebInspect, integrazione CI/CD, automazione, operation Linux/Docker e tool di supporto per i team di sviluppo. Sono particolarmente efficace in ruoli che combinano security engineering, software building e sistemi.}
%%%
...
\cventry{2024--\footnotesize{presente}}{Lead Cybersecurity Architect}{NTT Data Italia S.p.a.}{Roma}{}
        {Progettazione, upgrade, integrazione e presidio tecnico-operativo di piattaforme enterprise di Application Security per importanti clienti del settore bancario. Tra le principali attività svolte:
          \begin{itemize}
...
\cventry{2021--2024}{Lead Cybersecurity Architect}{NTT Data Italia S.p.a.}{Roma}{}
        {Coordinatore di un gruppo di Gestione Applicativa per \emph{Telecom Italia} in ambito Security.\\ Tra le piattaforme presidiate:
          ...
          \end{itemize}
          Responsabilità su organizzazione del lavoro, supporto operativo, amministrazione sistemistica e applicativa, monitoraggio, availability e applicazione di policy e best practice di cybersecurity.}
%%%
\vspace{3mm}
%%%
...
\cventry{2009--2019}{Analista Programmatore Senior}{Tecnorotoli S.r.l.}{Roma}{}
        {Progettazione, sviluppo, installazione e manutenzione per \emph{Policlinico Agostino Gemelli} di:
          ...
          \begin{itemize}
          \item Sviluppo di un'applicazione web di gestione contenuti su stack LAMP (Linux, Apache, MySQL, PHP)
...
\cvlistitem{Spiccate capacità comunicative, analitiche e di problem solving}
%%%
